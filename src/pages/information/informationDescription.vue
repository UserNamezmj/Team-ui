    ...
    <div class="app">
        <div class="wrap">
            ...
            <div ref="scrollBox">
                ...
                <div class="content_box" id="box" @click="HandleSmeill">
                ...
                <div class="bottom">
                    ...
                    <div v-if="isimlle" class="is_style_simlle" @click="chooseSimlle">
...
// let arrheight;
onMounted(() => {
    let socketUrl = import.meta.env == true ? "ws://localhost:8080/api/user/" + store.userId : "ws://112.124.54.146:8080/api/user/" + store.userId;
    // 开启一个websocket服务
...
function sendOut() {
    ...
    if (message.value.content && message.value.content !== undefined) {
...
function chooseSimlle(e) {
    if (e.target.textContent.length <= 2) {  //部分表情只占一位,同时如果点到旁边的一点区域会输出全部的表情有点bug
        form.value.inputValue = form.value.inputValue === undefined ? "" : form.value.inputValue + e.target.textContent
    }
}
